...
t_asm tab_x8632[] =
{
  ...
  {0, 0, "call eip+1 | pop %eax | ret", "\xe8\x00\x00\x00\x00\x58\xc3", 7},
  {0, 0, "call eip+1 | pop %ebx | ret", "\xe8\x00\x00\x00\x00\x5b\xc3", 7},
  {0, 0, "call eip+1 | pop %ecx | ret", "\xe8\x00\x00\x00\x00\x59\xc3", 7},
  {0, 0, "call eip+1 | pop %edx | ret", "\xe8\x00\x00\x00\x00\x5a\xc3", 7},
  {0, 0, "call eip+1 | pop %esi | ret", "\xe8\x00\x00\x00\x00\x5e\xc3", 7},
  {0, 0, "call eip+1 | pop %edi | ret", "\xe8\x00\x00\x00\x00\x5f\xc3", 7},
  {0, 0, "call eip+1 | pop %epb | ret", "\xe8\x00\x00\x00\x00\x5d\xc3", 7},
  {0, 0, "call *%gs:0x10", "\x65\xff\x15\x10\x00\x00\x00", 7},
  ...
  */
  ...
  {0, 0, "add $0x?,%esp | pop %ebp | ret", "\x83\xc4?\x5d\xc3", 5},
  {0, 0, "add $0x?,%esp | pop %ebx | ret", "\x83\xc4?\x5b\xc3", 5},
  {0, 0, "add $0x?,%esp | pop %ebx | pop %ebp | ret", "\x83\xc4?\x5b\x5d\xc3", 6},
  ...
  {0, 0, "sub $0x?,%ebx | call *%eax", "\x83\xeb?\xff\xd0", 5},
